    ...
    <div class="container">
        ...
        $con = mysqli_connect("localhost","root","","Paalan") or die("Couldn't connect");
         if(isset($_POST['submit'])){ // click submit
            ...
            $verify_query = mysqli_query($con,"SELECT Email FROM parent_users WHERE Email='$email'");
            if(mysqli_num_rows($verify_query)!=0){
                ...
                mysqli_query($con,"INSERT INTO parent_users (Username, Email,Woman_id, PASSWORD) VALUES('$username','$email','$Woman_id','$password')") or die("Error Occurred");
                echo "<div class='message'>
