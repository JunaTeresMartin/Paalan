...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM parent_users WHERE Email='$email'") or die("Select Error: " . mysqli_error($con));
        ...
        <div class="box form-box">
            ...
            <?php else : ?>
                ...
                <form action="" method="post">
                    ...
                    <div class="links">
                        Don't have an account? <a href="../ParentDashboaard/signup.php">Sign Up</a>
                    </div>
                </form>
            <?php endif; ?>
        </div>
